...
LIMIT=1000
OUT_FILE="scripts/symbols_bybit_spot_top1000.txt"
...
Generates a Bybit spot symbol list in broker format (e.g. BTC/USDT),
...
instruments_json="${tmp_dir}/bybit_spot_instruments.json"
tickers_json="${tmp_dir}/bybit_spot_tickers.json"

curl -fsS "https://api.bybit.com/v5/market/instruments-info?category=spot&limit=1000" -o "${instruments_json}"
curl -fsS "https://api.bybit.com/v5/market/tickers?category=spot" -o "${tickers_json}"
